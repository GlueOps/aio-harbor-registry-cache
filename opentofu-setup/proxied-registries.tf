...
module "dockerhub_proxy" {
  ...
  registry_endpoint_url = var.harbor_registry_mode == "REPLICA" ? 
    "https://${var.harbor_core_hostname}/proxy-docker-io" : 
...
module "quay_proxy" {
  ...
  registry_endpoint_url = var.harbor_registry_mode == "REPLICA" ? 
    "https://${var.harbor_core_hostname}/proxy-quay-io" : 
    "https://quay.io"
  admin_group_name = local.admin_group_name
}
...
module "gcr_proxy" {
  ...
  registry_endpoint_url = var.harbor_registry_mode == "REPLICA" ? 
    "https://${var.harbor_core_hostname}/proxy-gcr-io" : 
    "https://gcr.io"
  admin_group_name = local.admin_group_name
}
...
module "ghcr_proxy" {
  ...
  registry_provider = var.harbor_registry_mode == "REPLICA" ? "harbor" : "docker-hub"
  registry_endpoint_url = var.harbor_registry_mode == "REPLICA" ? 
    "https://${var.harbor_core_hostname}/proxy-ghcr-io" : 
    "https://ghcr.io"
  admin_group_name = local.admin_group_name
}
...
module "ecr_public_proxy" {
  ...
  registry_provider = var.harbor_registry_mode == "REPLICA" ? "harbor" : "docker-registry"
  registry_endpoint_url = var.harbor_registry_mode == "REPLICA" ? 
    "https://${var.harbor_core_hostname}/proxy-public-ecr-aws" : 
